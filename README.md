...
- If the application does not create one, you are expected to create it yourself following the format defined in the [Project Structure](#project-structure) section.
